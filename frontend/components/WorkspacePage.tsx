...
export function WorkspacePage({route}: {route: string}) {
  ...
  const {engagementId, engagement: eng, refresh, loading, role} = useEngagement();
    ...
    <>
      ...
      {eng && degraded && (
        <div className="notice warn">
          ...
          <span>
            <b>AI enrichment unavailable.</b> This stage completed using deterministic, evidence-only
            generation. Configure the AI provider to enable full enrichment.
          </span>
        </div>
      )}
