...
def load_settings():
    ...
    try:
        ...
        pass
    llm, db, app, image = cfg.get("llm", {}), cfg.get("databricks", {}), cfg.get("app", {}), cfg.get("image", {})
    return Settings(
        ...
        allow_mutations=_bool(_secret("CINVENT_ALLOW_MUTATIONS", db.get("allow_mutations", False))),
